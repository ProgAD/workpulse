-- dev seed, local only. login: admin@workpulse.test / admin123
USE hrms;
...
SELECT c.id, 'EMP001', 'admin@workpulse.test', '$2y$10$JZOjnym3B19SbNeNcH52d.qPCpa5QvVtrHv7ru/dbi2VkbJs7ryjK', r.id, 'active', NOW()
